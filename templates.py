...
# Templates for prompting CLIP, these are from the original CLIP repository.
...
# augment the ones with too few templates. GPT-4 was used to do this.
...
# imagenet-a and imagenet-r only have 200 of the 1000 classes
