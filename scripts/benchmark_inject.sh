...
clip_model=$1
n_shots=$2
python main.py caltech-101 "$clip_model" "$n_shots" CLIP_CALTECH_TEMPLATES --epochs 30
...
python main.py oxford_flowers "$clip_model" "$n_shots" AUGMENTED_FLOWERS_TEMPLATES --epochs 40
python main.py oxford_pets "$clip_model" "$n_shots" AUGMENTED_OXFORD_PETS_TEMPLATES  --epochs 35
python main.py standford_cars "$clip_model" "$n_shots" AUGMENTED_STANDFORD_CARS_TEMPLATES --epochs 30
...
python main.py imagenet "$clip_model" 16 CLIP_IMAGENET_TEMPLATES --epochs 15
