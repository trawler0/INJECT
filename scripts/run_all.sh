...
bash scripts/benchmark_clip_soup.sh ViT-B/32 "eurosat" 2 0.5 10
bash scripts/benchmark_clip_soup.sh ViT-B/32 "eurosat" 4 0.5 10
bash scripts/benchmark_clip_soup.sh ViT-B/32 "eurosat" 8 0.5 10
bash scripts/benchmark_clip_soup.sh ViT-B/32 "eurosat" 16 0.5 10

for dataset in "eurosat" "caltech-101" "dtd" "food-101" "oxford_flowers" "oxford_pets" "standford_cars" "ucf101"
do
  # Benchmarking DinoV2
