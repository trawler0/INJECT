import clip
from inject import INJECT, TipAdapter
...
def main():
    ...
    parser.add_argument("inject_checkpoint", type=str)
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        inject_model = INJECT(backbone, prompts, test_flags=test_flags, weighing_strategy=args.weighing_strategy)
        inject_model = torch.load(args.inject_checkpoint)
        model = TipAdapter(inject_model, tau=args.tau, beta=args.beta)
